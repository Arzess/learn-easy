// Write the icons here for export
const chervonRight = `<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export default function findSvg(i: String, white: boolean){
    ...
    if (white){
        return svgString.replace(`fill="black"`, `fill="white"`);
    } 
    else{
        return svgString.replace(/fill="white"/g, 'fill="black"');
